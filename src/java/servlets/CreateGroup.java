...
public class CreateGroup extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            out.println("<h3 align=\"center\"><span class=\"label label-info\">Crea un gruppo</span></h3>");
            ...
            out.println("               <button type=\"submit\" class=\"btn btn-default\" name=\"btn\" value=\"grpConferma\">Conferma</button>");
            out.println("               <button type=\"submit\" class=\"btn btn-default\" name=\"btn\" value=\"Annulla\">Annulla</button>");
            out.println("           </div>");
            out.println("       </div>");
            out.println("</div>");
            
            PHUtils.printUsersTable(out, request, response, manager, user.getUserID());
