 ...
 * @author giorgio
 */
public class AcceptInvites extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            out.println("<h3 align=\"center\"><span class=\"label label-info\">Accetta gli inviti</span></h3>");
            ...
            PHUtils.printInviesTable(out, request, response, manager, user.getUserID());
            out.println("       </div>");
            ...
            out.println("               <button type=\"submit\" class=\"btn btn-default\" name=\"btn\" value=\"aciConferma\">Conferma</button>");
