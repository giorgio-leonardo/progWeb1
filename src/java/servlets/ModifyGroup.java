...
public class ModifyGroup extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        session.setAttribute("oldName", groupName);
        
        response.setContentType("text/html;charset=UTF-8");
        try (PrintWriter out = response.getWriter())
        {
            PHUtils.pageHeader(out);
            out.println("<h3 align=\"center\"><span class=\"label label-info\">Modifica il gruppo: "+ groupName +"</span></h3>");
            ...
            out.println("           <input type=\"text\" class=\"form-control\" placeholder=\"" + groupName + "\" name=\"groupName\">");
            out.println("       </div>");
            ...
            out.println("               <button type=\"submit\" class=\"btn btn-default\" name=\"btn\" value=\"grpMGConferma\">Conferma</button>");
