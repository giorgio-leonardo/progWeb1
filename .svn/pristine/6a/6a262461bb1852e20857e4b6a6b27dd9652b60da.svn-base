...
public class ViewGroup extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try (PrintWriter out = response.getWriter())
        {
            ...
            out.println("<h3 align=\"center\"><span class=\"label label-info\">Post del gruppo</span></h3>");
            ...
            PHUtils.printPostsTable(out, session, manager, groupID);
            ...
            out.println("               <button type=\"submit\" class=\"btn btn-default\" name=\"btn\" value=\"vgAggiungiPost\">Aggiungi post</button>");
            out.println("               <button type=\"submit\" class=\"btn btn-default\" name=\"btn\" value=\"vgStampaPDF\">Stampa PDF</button>");
